...
class EntityCache
  ...
  def mention(username, domain)
    Rails.cache.fetch(to_key(:mention, username, domain), expires_in: MAX_EXPIRATION) { Account.select(:id, :username, :domain, :url, :actor_type, :moved_to_account_id).find_remote(username, domain) }
  end
