...
module ContextHelper
  ...
  CONTEXT_EXTENSION_MAP = {
    ...
    copyright_notice: { 'schema' => 'http://schema.org#', 'copyrightNotice' => 'schema:copyrightNotice' },
    credit_text: { 'schema' => 'http://schema.org#', 'creditText' => 'schema:creditText' },
    usage_info: { 'schema' => 'http://schema.org#', 'usageInfo' => 'schema:usageInfo' },
    related_link: { 'schema' => 'http://schema.org#', 'relatedLink' => 'schema:relatedLink' },
    ...
    'free_text': { 'misskey' => 'https://misskey-hub.net/ns#', 'schema' => 'http://schema.org#', 'freeText' => { '@id' => 'misskey:freeText', '@type' => 'schema:text' } },
