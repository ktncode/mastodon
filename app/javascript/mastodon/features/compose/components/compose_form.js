...
const messages = defineMessages({
  ...
  update: {
    id: "compose_form.update_scheduled_status",
    defaultMessage: "Update scheduled post",
  },
  delete: {
    id: "compose_form.delete_scheduled_status",
...
class ComposeForm extends ImmutablePureComponent {
  ...
  canSubmit = () => {
    ...
    const ngWords = prohibitedWords.some(
      (word) => text.includes(word) || spoilerText?.includes(word)
    );
  ...
  render() {
    ...
    } else if (this.props.isScheduledStatusEditting) {
      if (this.props.isScheduled) {
        publishText = (
          <span className="compose-form__update">
        ...
        publishText = (
          <Fragment>
            <span className="compose-form__delete">
        ...
        <div className="compose-form__publish">
          <div className="compose-form__publish-button-wrapper">
            <Button
              ...
              disabled={disablePost || !this.canSubmit()}
              block
            />
          </div>
        </div>
