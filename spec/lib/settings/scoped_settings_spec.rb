...
RSpec.describe Settings::ScopedSettings do
  ...
  let(:val)            { 'whatever' }
  let(:methods)        { %i(auto_play_gif default_sensitive follow_modal unfollow_modal subscribe_modal unsubscribe_modal follow_tag_modal unfollow_tag_modal boost_modal delete_modal reduce_motion system_font_ui noindex theme) }
