...
class Rack::Attack
  ...
  throttle('throttle_statuses_updated_polling', limit: 300, period: 1.minutes) do |req|
    req.throttleable_remote_ip if req.path.start_with?('/api/v1/statuses/updated')
  end
  ...
  throttle('throttle_authenticated_paging', limit: 900, period: 15.minutes) do |req|
    req.authenticated_user_id if req.paging_request?
  end

  throttle('throttle_unauthenticated_paging', limit: 900, period: 15.minutes) do |req|
